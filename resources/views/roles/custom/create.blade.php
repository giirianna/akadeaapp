            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-style mb-30">
                        ...
                        <form action="{{ route('roles.custom.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-style-1">
                                        ...
                                        <input type="text" id="name" name="name" placeholder="e.g., librarian" value="{{ old('name') }}" required>
                                        <small class="text-muted">Use lowercase letters and underscores only (e.g., custom_role)</small>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-style-1">
                            ...
                            <div class="d-flex gap-2 mt-4">
                                <button type="submit" class="main-btn primary-btn btn-hover">
                                    <i class="lni lni-save"></i> Create Role
                                </button>
