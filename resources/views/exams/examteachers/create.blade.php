        ...
        <div class="card mb-4 shadow-sm">
            <div class="card-body">
                ...
                <div class="row g-3 mt-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="subject" class="form-control form-select-lg" required>
                            ...
                            @foreach(['Matematika', 'Bahasa Indonesia', 'Bahasa Inggris', 'Fisika', 'Kimia', 'Biologi', 'Sejarah', 'Ekonomi', 'Geografi', 'Sosiologi', 'Pendidikan Agama', 'PJOK', 'Seni Budaya', 'TIK'] as $subj)
                ...
                <div class="mt-3">
                    ...
                    <textarea name="description" class="form-control" rows="2" placeholder="Tambahkan instruksi atau catatan untuk siswa..."></textarea>
                </div>
            </div>
        </div>
