                        ...
                        <div class="breadcrumb-wrapper">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('spp.index') }}">Pembayaran SPP</a></li>
                        ...
                        <form action="{{ route('spp.store') }}" method="POST">
                            ...
                            <div class="card-style mb-30">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" name="student_name" id="student_name"
                                        placeholder="Nama siswa akan terisi otomatis" readonly />
                                    @error('student_name')
                                        <span class="text-danger small">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="card-style mb-30">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" name="class" id="class" placeholder="Kelas akan terisi otomatis"
                                        readonly />
                                    @error('class')
                                        <span class="text-danger small">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="card-style mb-30">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" name="major" id="major" placeholder="Jurusan akan terisi otomatis"
                                        readonly />
                                    @error('major')
                                        <span class="text-danger small">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="card-style mb-30">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" name="month" id="month" placeholder="Januari, Februari, dst"
                                        required />
                                    @error('month')
                                        <span class="text-danger small">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="card-style mb-30">
                                <div class="input-style-1">
                                    ...
                                    <input type="text" name="payment_method" id="payment_method"
                                        placeholder="Misalnya: Transfer, Tunai, dll" />
                            ...
                            <div class="card-style mb-30">
                                ...
                                <textarea name="remarks" id="remarks" class="form-control" rows="4"
                                    placeholder="Catatan tambahan (opsional)">{{ old('remarks') }}</textarea>
                                @error('remarks')
                                    <span class="text-danger small">{{ $message }}</span>
                                @enderror
                            </div>
