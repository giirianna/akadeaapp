                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-style-1">
                                        ...
                                        <input type="text" name="subject_code" id="subject_code"
                                            value="{{ old('subject_code') }}" placeholder="Contoh: MP-001" required>
                                        @error('subject_code')
                                ...
                                <div class="col-md-6">
                                    <div class="input-style-1">
                                        ...
                                        <div class="multiselect-dropdown">
                                            <button type="button" class="multiselect-btn" id="classLevelDropdownBtn"
                                                ...
                                                @foreach($classLevels as $level)
                                                    <li>
                                                        <label class="dropdown-item d-flex align-items-center gap-2 rounded">
                                                            <input type="checkbox" name="class_level[]" value="{{ $level }}"
                                                                class="form-check-input m-0 class-level-checkbox" {{ is_array(old('class_level')) && in_array($level, old('class_level')) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="input-style-1">
                                        ...
                                        <div class="multiselect-dropdown">
                                            <button type="button" class="multiselect-btn" id="majorDropdownBtn"
                                                data-bs-toggle="dropdown" aria-expanded="false">
                                                -- Pilih Jurusan --
                                            </button>
                                            <ul class="dropdown-menu p-2 w-100" id="majorDropdown">
                                                @foreach($majors as $major)
                                                    <li>
                                                        <label class="dropdown-item d-flex align-items-center gap-2 rounded">
                                                            <input type="checkbox" name="major_id[]" value="{{ $major->id }}"
                                                                class="form-check-input m-0 major-checkbox" {{ is_array(old('major_id')) && in_array($major->id, old('major_id')) ? 'checked' : '' }}>
                                                            <span>{{ $major->name }}
                                                                @if($major->code)({{ $major->code }})@endif</span>
                                                        </label>
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </div>
                                        <small class="text-muted">Pilih satu atau lebih jurusan dari Major module</small>
                                        @error('major_id')
                                            <div class="text-danger mt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
